...
The compiled jar is hosted on Maven Central: [FROST-Manager-0.14-jar-with-dependencies.jar](https://repo1.maven.org/maven2/de/fraunhofer/iosb/ilt/FROST-Manager/0.14/FROST-Manager-0.14-jar-with-dependencies.jar)


## Running

Start it with the command
```java -jar FROST-Manager-0.14-jar-with-dependencies.jar```
